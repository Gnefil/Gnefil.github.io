...
subtitle: Brain Computer Interface (BCI) always had a role in utopic future. It is an ambitious technology that connects human brain with digital computers. What if one day we want a BCI connected, how would you choose between these two main types; non-invasive BCI or invasive BCI?
...
---
This post in specific, we will discuss why should we go for a non-invasive BCI instead of invasive BCI.
